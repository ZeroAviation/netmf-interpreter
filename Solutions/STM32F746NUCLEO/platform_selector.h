...
#define STM32F7_UART_TXD_PINS { PORT_PIN(GPIO_PORTA,  9), PORT_PIN(GPIO_PORTA, 2) }
#define STM32F7_UART_RXD_PINS { PORT_PIN(GPIO_PORTA, 10), PORT_PIN(GPIO_PORTA, 3) }
...
// User LEDs
#define LED1                            PORT_PIN(GPIO_PORTB,  0)  // Green
#define LED2                            PORT_PIN(GPIO_PORTB,  7)  // Blue
#define LED3                            PORT_PIN(GPIO_PORTB, 14)  // Red
